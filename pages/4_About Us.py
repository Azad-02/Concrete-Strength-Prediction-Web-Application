...
st.divider()
st.write("<h3 style='text-align: center;'>Meet the team behind this Project!</h3>", unsafe_allow_html=True)
...
with developer2:
    ...
    with column1:
        ...
        st.markdown('''
                    ...
                    ''')
        st.markdown(''' <a href = "https://www.linkedin.com/in/mohit-bhaisare-a56933182">
